...
public class Estoque {
	...
	public void imprimir() {
		...
		System.out.println("Total de Entrada: \tR$" + (double)tEntrada);
		System.out.println("Total de Saida: \tR$" +(double) tSaida);
		System.out.println("Saldo total:\t\t R$" + (double)(tEntrada-tSaida));
	}
	...
	public void cadSaida() {
		System.out.println("Tipo de saida: ");
		String n = scan.next();
		System.out.println("Valor: ");
		double d = scan.nextDouble();
	...
	public void editSaida() {
		System.out.println("Id: ");
		int id = scan.nextInt();
		System.out.printf("Tipo de saida: ");
		String n = scan.next();
		System.out.println("Valor: ");
		double d = scan.nextDouble();
